...
//        $letter= Letter::get();
        ...
        return view('home.index', compact('works', $works,'categories', $categories, 'sliders', $sliders,  'news', $news, 'complaints', $complaints, 'usefull_links', $usefull_links, 'slider_todays', $slider_todays));
    }
}
