        ...
        <div class class=" collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="{{route('letter', ['letter'=>'letter'])}}">{{__('all.online_applications')}}</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="{{route('appelyasiya', ['appelyasiya'=>'appelyasiya'])}}">{{__('all.Procedure_for_filing_an_appeal')}}</a>
